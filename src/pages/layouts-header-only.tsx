        ...
        <section className="space-y-5" aria-labelledby="header-only-second-area-heading">
          ...
          <div className="space-y-8">
            <div className="space-y-3">
              ...
              <SplitPaneDemo secondarySize="third" mainColumns={{ base: 1, sm: 2, md: 3, lg: 4 }} mainCardCount={8} />
            </div>
            <div className="space-y-3">
              <h3 className="text-lg font-semibold">Equal room for both areas</h3>
              <SplitPaneDemo secondarySize="half" mainColumns={{ base: 1, sm: 2, md: 3, lg: 4 }} mainCardCount={8} />
            </div>
          </div>
        </section>
      </Main>
