        ...
        <PageBody>
          ...
          <Main size="full">
            <div className="space-y-12 px-4 pb-12 pt-6 sm:px-6 lg:px-8">
              ...
              <section className="space-y-5" aria-labelledby="navigation-sidebar-example-heading"><h2 id="navigation-sidebar-example-heading" className="text-2xl font-semibold tracking-tight">Example configuration</h2><pre className="overflow-x-auto rounded-xl border bg-muted/40 p-5 text-sm"><code>{`<Sidebar
