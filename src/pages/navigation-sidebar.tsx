      ...
      <PageShell>
        ...
        <PageBody>
          ...
          <section className="space-y-5" aria-labelledby="navigation-sidebar-responsive-heading">
            <h2 id="navigation-sidebar-responsive-heading" className="text-2xl font-semibold tracking-tight">
              Responsive behavior
            </h2>
            <p className="leading-7 text-muted-foreground">On wider screens, the Sidebar sits beside Main. On narrow screens, it moves into the Header's mobile menu while Main remains the first reading area.</p>
          </section>
            </div>
          </Main>
        </PageBody>
